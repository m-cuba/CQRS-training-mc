...
using Sportsbook.ServiceTemplate.API.Controllers;
...
namespace Sportsbook.ServiceTemplate.API.Tests.Controllers
{
    [TestFixture]
    public class InventoryControllerTests
    {
        ...
        {
            A.CallTo(() => _getBySkuHandler.Handle(A<GetItemBySkuQuery>._, CancellationToken.None))
                .Returns((InventoryItemDto?)null);
